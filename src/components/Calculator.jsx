...
function Calculator() {
  ...
  const [darkMode, setDarkMode] = useState(() => {
    // Baca status darkMode dari localStorage saat pertama kali aplikasi dimuat
    const savedDarkMode = localStorage.getItem("darkMode");
    return savedDarkMode !== null ? savedDarkMode === "true" : false; // Default ke light mode
  });

  // Simpan status darkMode ke localStorage setiap kali berubah
  useEffect(() => {
